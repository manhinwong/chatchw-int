...
import WheelPickerDays from './components/wheelpickers/wheelpickerDays';
...
const handleClick = () => {
    let output = selectedOption || inputText || DaysValue;
